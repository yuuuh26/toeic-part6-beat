const CACHE='part6-beat-v1.2.0';
const ASSETS=['./','./index.html','./styles.css','./bgm.css','./data.js','./app.js','./bgm.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable-512.png'];
